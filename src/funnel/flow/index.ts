...
import { INTRO } from "@/funnel/flow/intro";
...
import { OUTRO } from "@/funnel/flow/outro";

export const FLOW: Beat[] = [...INTRO, ...STEP1, ...STEP1_NO, ...STEP1_YES, ...STEP1_END, ...STEP2, ...STEP3, ...STEP4, ...OUTRO];
