...
export const STEP2: Beat[] = [
  ...
  { t: "ask", id: "location", q: { kind: "yesNoText", placeholder: "Enter a country or city" } },
  { t: "bot", text: "Got it!" },
  ...
  { t: "ask", id: "pain", q: { kind: "text", placeholder: "Describe their pain points" } },
  { t: "bot", text: "And here comes the final question... drumroll 🥁" },
  { t: "bot", text: "How would you describe your ideal target audience?" },
  { t: "ask", id: "ideal-audience", q: { kind: "text", placeholder: "Describe your ideal audience" } },
