...
export const STEP2: Beat[] = [
  ...
  { t: "ask", id: "location", q: { kind: "yesNoText", placeholder: "Type here..." } },
  { t: "bot", text: "Got it!" },
