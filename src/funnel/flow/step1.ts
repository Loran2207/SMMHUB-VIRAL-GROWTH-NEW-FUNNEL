...
export const STEP1: Beat[] = [
  ...
  { t: "ask", id: "describe", q: { kind: "single", custom: true, customPlaceholder: "Describe yourself in a few words", options: DESCRIBE_OPTIONS } },
  { t: "bot", text: "Got it! 🙌" },
...
export const STEP1_NO: Beat[] = [
  ...
  { t: "ask", when: no, id: "skills", q: { kind: "text", placeholder: "Share your skills, experience or hobbies" } },
  { t: "bot", when: no, text: "Got it!" },
  { t: "bot", when: no, text: "What topics do you love learning about?" },
  { t: "ask", when: no, id: "topics", q: { kind: "text", placeholder: "Tell me the topics you love" } },
  { t: "bot", when: no, text: "Okay, noted!" },
  { t: "bot", when: no, text: "Who do you love helping or chatting with the most?" },
  { t: "ask", when: no, id: "helping", q: { kind: "text", placeholder: "Describe who you love helping" } },
  { t: "bot", when: no, text: "Aha, got it!" },
  { t: "bot", when: no, text: "Is there anything people usually ask you for advice on?" },
  { t: "ask", when: no, id: "advice", q: { kind: "text", placeholder: "Share what people ask you about" } },
...
export const STEP1_YES: Beat[] = [
  ...
  { t: "ask", when: yes, id: "niche-list", q: { kind: "nicheList", custom: true, customPlaceholder: "Type your niche", options: [
...
export const STEP1_END: Beat[] = [
  ...
  { t: "ask", id: "topics-include", q: { kind: "yesNoText", placeholder: "Share the topics to include" } },
  { t: "bot", text: "Got you!" },
  { t: "bot", text: "Are there any topics you'd like to avoid in your content?" },
  { t: "ask", id: "topics-avoid", q: { kind: "yesNoText", placeholder: "Share the topics to avoid" } },
  { t: "bot", text: "Almost there, creator! 🔜" },
  { t: "bot", text: "Is there anything that makes you or your brand stand out?" },
  { t: "ask", id: "unique-feature", q: { kind: "yesNoText", placeholder: "Share what makes you stand out", example: EXAMPLE_ASK } },
  ...
  { t: "ask", when: wantsExample, id: "unique-answer", q: { kind: "yesNoText", placeholder: "Share what makes you stand out", no: "Not yet - I'm still discovering my unique angle", yes: "Yes - I have a clear \"thing\" that makes my content feel like me" } },
